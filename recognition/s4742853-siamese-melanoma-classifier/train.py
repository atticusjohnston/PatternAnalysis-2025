...
if __name__ == "__main__":
    ...
    train_loader = DataLoader(train_dataset, batch_size=args.batch_size, num_workers=6, persistent_workers=True, shuffle=True)
    val_loader = DataLoader(val_dataset, batch_size=args.batch_size, num_workers=6, persistent_workers=True, shuffle=False)
